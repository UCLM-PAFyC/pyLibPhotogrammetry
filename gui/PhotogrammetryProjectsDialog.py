...
class PhotogrammetryProjectsDialog(QDialog):
    ...
    def add_project(self):
        ...
        photogrammetry_project[defs_prj_dlg.FIELD_DATE] = str_date
        photogrammetry_project[defs_prj_dlg.FIELD_ENABLED] = 1
        photogrammetry_project[defs_prj_dlg.FIELD_CRS] = crs_id
        photogrammetry_project[defs_prj_dlg.FIELD_DESCRIPTION] = ""
        photogrammetry_project[defs_prj_dlg.FIELD_FILE] = file_path
        photogrammetry_project[defs_prj_dlg.FIELD_ORTHOMOSAIC] = ''
        photogrammetry_project[defs_prj_dlg.FIELD_ORTHOMOSAIC_CRS] = crs_id
        photogrammetry_project[defs_prj_dlg.FIELD_DSM] = ''
        photogrammetry_project[defs_prj_dlg.FIELD_DSM_CRS] = crs_id
        photogrammetry_project[defs_prj_dlg.FIELD_DTM] = ''
        photogrammetry_project[defs_prj_dlg.FIELD_DTM_CRS] = crs_id
        photogrammetry_project[defs_prj_dlg.FIELD_POINT_CLOUD] = ''
        photogrammetry_project[defs_prj_dlg.FIELD_POINT_CLOUD_CRS] = crs_id
    ...
    def disable(self):
        ...
        for i in range(self.tableWidget.rowCount()):
            ...
            if id_item.isSelected():
                id = id_item.text()
                if self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ENABLED] == 1:
                    enabled_item = self.tableWidget.item(i, 2)
                    enabled_item.setText("False")
                    self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ENABLED] = 0
        return
    ...
    def enable(self):
        ...
        for i in range(self.tableWidget.rowCount()):
            ...
            if id_item.isSelected():
                id = id_item.text()
                if self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ENABLED] == 0:
                    enabled_item = self.tableWidget.item(i, 2)
                    enabled_item.setText("True")
                    self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ENABLED] = 1
        return
    ...
    def format_changed(self):
        ...
        elif format == defs_prj_dlg.FORMAT_GEOMATIC_PRODUCTS:
            self.idPushButton.setEnabled(True)
            self.datePushButton.setEnabled(True)
            self.addProjectPushButton.setEnabled(True)
    ...
    def initialize(self, title):
        ...
        if len(defs_prj_dlg.extension_by_format) > 1:
            self.formatComboBox.addItem(defs_prj_dlg.CONST_NO_COMBO_SELECT)
        for format in defs_prj_dlg.extension_by_format:
        ...
        headers = defs_prj_dlg.headers
        headers_tooltips = defs_prj_dlg.header_tooltips
    ...
    def on_click(self, item):
        ...
        if label == defs_prj_dlg.HEADER_DESCRIPTION_TAG:
            ...
            if text != self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DESCRIPTION]:
                self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DESCRIPTION] = text
            return
        elif label == defs_prj_dlg.HEADER_DATE_TAG:
            # return
            str_date = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DATE]
            date = QDate.fromString(str_date, defs_prj_dlg.DATE_FORMAT)
            ...
            # return str_error, is_saved
            str_date = date.toString(defs_prj_dlg.DATE_FORMAT)
            self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DATE] = str_date
            item.setText(str_date)
        elif (label == defs_prj_dlg.HEADER_ORTHOMOSAIC_TAG
              or label == defs_prj_dlg.HEADER_DSM_TAG
              or label == defs_prj_dlg.HEADER_DTM_TAG
              or label == defs_prj_dlg.HEADER_POINT_CLOUD_TAG):
            file_extensions = None
            tile = ''
            previous_file_path = ''
            name_filter = ''
            if label == defs_prj_dlg.HEADER_ORTHOMOSAIC_TAG:
                file_extensions = defs_prj_dlg.orthomosaic_file_extensions
                title = "Select Orthomosaic file"
                name_filter = "Orthomosaic file ("
                previous_file_path = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ORTHOMOSAIC]
            elif label == defs_prj_dlg.HEADER_DSM_TAG or label == defs_prj_dlg.HEADER_DTM_TAG:
                file_extensions = defs_prj_dlg.dem_file_extensions
                if label == defs_prj_dlg.HEADER_DSM_TAG:
                    title = "Select DSM file"
                    name_filter = "DSM file ("
                    previous_file_path = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DSM]
                else:
                    title = "Select DTM file"
                    name_filter = "DTM file ("
                    previous_file_path = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DTM]
            else:
                file_extensions = defs_prj_dlg.point_cloud_file_extensions
                title = "Select Point Cloud file"
                name_filter = "Point Cloud file ("
                previous_file_path = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_POINT_CLOUD]
            ...
            if file_path:
                ...
                if file_path != previous_file_path:
                    if label == defs_prj_dlg.HEADER_ORTHOMOSAIC_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ORTHOMOSAIC] = file_path
                    elif label == defs_prj_dlg.HEADER_DSM_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DSM] = file_path
                    elif label == defs_prj_dlg.HEADER_DTM_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DTM] = file_path
                    elif label == defs_prj_dlg.HEADER_POINT_CLOUD_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_POINT_CLOUD] = file_path
                    item.setText(file_path)
        elif (label == defs_prj_dlg.HEADER_ORTHOMOSAIC_CRS_TAG
              or label == defs_prj_dlg.HEADER_DSM_CRS_TAG
              or label == defs_prj_dlg.HEADER_DTM_CRS_TAG
              or label == defs_prj_dlg.HEADER_POINT_CLOUD_CRS_TAG):
            tile = ''
            previous_crs_id = ''
            if label == defs_prj_dlg.HEADER_ORTHOMOSAIC_CRS_TAG:
                file_extensions = defs_prj_dlg.orthomosaic_file_extensions
                title = "Select Orthomosaic CRS"
                previous_crs_id = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ORTHOMOSAIC_CRS]
            elif label == defs_prj_dlg.HEADER_DSM_TAG:
                    title = "Select DSM CRS"
                    previous_crs_id = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DSM_CRS]
            elif label == defs_prj_dlg.HEADER_DTM_CRS_TAG:
                    title = "Select DTM CRS"
                    previous_crs_id = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DTM_CRS]
            else:
                title = "Select Point Cloud CRS"
                previous_crs_id = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_POINT_CLOUD_CRS]
            ...
            if dialog.is_accepted:
                ...
                if crs_id != previous_crs_id:
                    if label == defs_prj_dlg.HEADER_ORTHOMOSAIC_CRS_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ORTHOMOSAIC_CRS] = crs_id
                    elif label == defs_prj_dlg.HEADER_DSM_CRS_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DSM_CRS] = crs_id
                    elif label == defs_prj_dlg.HEADER_DTM_CRS_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DTM_CRS] = crs_id
                    elif label == defs_prj_dlg.HEADER_POINT_CRS_CLOUD_TAG:
                        self.photogrammetry_projects[id][defs_prj_dlg.FIELD_POINT_CLOUD_CRS] = crs_id
                    item.setText(crs_id)
        return
    ...
    def select_file(self):
        ...
        str_content = ('Photogrammetry Project File (*.{})'.format(defs_prj_dlg.extension_by_format[selected_format]))
    ...
    def update_gui(self):
        ...
        for id in self.photogrammetry_projects:
            ...
            # crs
            crs_id = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_CRS]
            ...
            description = defs_prj_dlg.RESUME_CONTENT
            ...
            # file
            file_path = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_FILE]
            ...
            # orthomosaic
            orthomosaic = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ORTHOMOSAIC]
            ...
            # orthomosaic crs
            orthomosaic_crs = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_ORTHOMOSAIC_CRS]
            ...
            # dsm
            dsm = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DSM]
            ...
            # dsm crs
            dsm_crs = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DSM_CRS]
            ...
            # dtm
            dtm = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DTM]
            ...
            # dtm crs
            dtm_crs = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_DTM_CRS]
            ...
            # point cloud
            point_cloud = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_POINT_CLOUD]
            ...
            # dtm crs
            point_cloud_crs = self.photogrammetry_projects[id][defs_prj_dlg.FIELD_POINT_CLOUD_CRS]
